...
class AnaliticaDemografia extends Component {
  constructor(props) {
    super(props);
...
distribucionNHijosH(){
  return this.contarRepetidos(this.filtrarTutotes( this.state.tutores,{sexo:0}),'numeroHijos');
}

distribucionNHijosM(){
  return this.contarRepetidos(this.filtrarTutotes( this.state.tutores,{sexo:1}),'numeroHijos');
}
...
filtrarTutotes(datos, propiedad){
  ...
  cambiarFiltro(filtro)
  {
    ...
    else if(filtro === "nHijosH"){
      titulo="Número de hijos tutores (hombres)";
      this.state.etiquetas = Object.keys(this.distribucionNHijosH());
      this.state.datos = Object.values(this.distribucionNHijosH());
      this.state.colores =this.llenarColoresAzules(this.state.etiquetas.length);
    }

    else if(filtro === "nHijosM"){
      titulo="Número de hijos tutoras (Mujeres)";
      this.state.etiquetas = Object.keys(this.distribucionNHijosM());
      this.state.datos = Object.values(this.distribucionNHijosM());
      this.state.colores =this.llenarColoresRosados(this.state.etiquetas.length);
    }
    ...
    return (
      <div>
            <div className="form-group">
                ...
                <option value="nHijosH">Número de Hijos (hombres)</option>
                <option value="nHijosM">Número de Hijos (mujeres)</option>
        ...
        <div>
          <div className="bg-c-blue shadow text-light" >
            ...
            <h5 className="text-center raleway">          
                  Dashboard: Información demográfica              
              <br />
              <br />
              <br />
            </h5>
                   ...
                   <ReactHint autoPosition events delay={{show: 100, hide: 1000}} />
                    <ReactHint persist
                      ...
                      ref={(ref) => this.instance = ref} />
                        <p   
                            data-rh="Se muestran 4 diferentes tipos de gráficos para la información demográfica de Tutores y niños. Para ver dicha información utiliza los Filtros ↓" 
                            data-rh-at="bot">
...
export default AnaliticaDemografia;